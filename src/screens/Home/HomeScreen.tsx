...
export const HomeScreen: React.FC = () => {
	...
	const galleryItems = [
		{
			img: "/extracted_images/image1.jpeg",
			category: "Apparel Training (Samarth)",
			title: "Sewing Machine Operator Session",
			desc: "Female candidates learning apparel manufacturing skills inside Jaina Woolen Mills, Panipat."
		},
		{
			img: "/extracted_images/image6.jpeg",
			category: "Digital Skills (Mahindra CSR)",
			title: "Vocational IT Laboratory Class",
			desc: "Trainees developing computer literacy and service operations capabilities in Rudrapur."
		},
		{
			img: "/extracted_images/image15.jpeg",
			category: "Electrician RPL (Crompton)",
			title: "Safety & Competency Certification",
			desc: "Electricians undergoing assessments and technical safety safety certification program."
		},
		{
			img: "/extracted_images/image21.jpeg",
			category: "Waste Management (Tenneco)",
			title: "Gurugram Plogging & Cleaning Drive",
			desc: "Corporate volunteers participating in public clean-up drives promoting clean and green cities."
		}
	];

	const projects = [
		{
			sector: "Ministry of Textiles",
			title: "Samarth Yojna Apparel Training",
			desc: "Partnered with Jaina Woolen Mills, Panipat to train female candidates in Rohtak and Panipat. Equipped participants as Sewing Machine Operators, facilitating direct placements and boutique entrepreneurship.",
			metric: "460",
			metricLabel: "Female Candidates Trained",
			color: "bg-[#ebf3f7] text-primary"
		},
		{
			sector: "Mahindra & Mahindra CSR",
			title: "Prerna Skill Development Centre",
			desc: "Collaborated with Centum Foundation in Rudrapur to deliver vocational training. Certified female candidates as Data Entry Operators, Inventory Clerks, and Customer Care Executives.",
			metric: "360",
			metricLabel: "Female Candidates Trained",
			color: "bg-[#fff2eb] text-accent"
		},
		{
			sector: "Crompton CSR",
			title: "ESSCI Electrician RPL Programme",
			desc: "Delivered a structured Recognition of Prior Learning (RPL) safety certification program across Delhi NCR and Gujarat locations, training local electricians in core technical domains and soft skills.",
			metric: "392",
			metricLabel: "Electricians Trained",
			color: "bg-[#ebf3f7] text-primary"
		},
		{
			sector: "Medhavi Foundation",
			title: "IT Literacy & Soft Skills Initiative",
			desc: "Delivered short-term technical training programs across multiple locations, building essential computer literacy, IT fundamentals, and professional communication skills for students.",
			metric: "2,800+",
			metricLabel: "Candidates Trained",
			color: "bg-[#fff2eb] text-accent"
		},
		{
			sector: "Tenneco CSR",
			title: "Community Plogging & Waste Management Drive",
			desc: "Partnered with Employ India Foundation to organize a clean-up and environmental awareness drive in Gurugram, engaging corporate volunteers to clear waste and promote green municipal disposal.",
			metric: "130 KG",
			metricLabel: "Waste Collected (60 Volunteers)",
			color: "bg-[#ebf3f7] text-primary"
		}
	];
						...
						<div className="lg:col-span-6 flex justify-center lg:justify-end animate-fade-in">
							<div className="relative w-full max-w-lg lg:max-w-none">
								...
								<div className="absolute bottom-6 -right-6 bg-white p-4 rounded-2xl shadow-xl flex items-center gap-3 border border-gray-100 animate-bounce-slow max-w-[190px]">
									...
									<div>
										<div className="text-[20px] font-extrabold text-primary leading-none">4,072+</div>
										<div className="text-[11px] font-bold text-muted mt-1 leading-tight">Individuals Trained</div>
									</div>
								</div>
							</div>
						</div>
			...
			<section id="impact" className="bg-[#0b1b2d] py-12 relative overflow-hidden">
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
					<div className="grid grid-cols-2 md:grid-cols-4 gap-8 lg:gap-12">
						{[
							{ num: "4,072+", label: "Individuals skilled", icon: <Users size={22} /> },
							{ num: "75%+", label: "Minimum Placement after training", icon: <Briefcase size={22} /> },
							{ num: "820+", label: "Women empowered", icon: <Heart size={22} /> },
							{ num: "392", label: "Electricians certified", icon: <Award size={22} /> },
						].map((stat, i) => (
							<div
								key={i}
						...
						<div className="lg:col-span-7 flex flex-col gap-6">
							{[
								...
								},
								{
									step: "04",
									title: "Employ",
									desc: "Supporting active access to livelihoods and career employment with a minimum 75% placement rate through dedicated job fairs, placement linkages, and industry networks."
								},
								{
									step: "05",
									title: "Empower",
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					...
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
						{projects.map((project, idx) => (
							<div
								key={idx}
								className="bg-white rounded-xl border border-gray-150 overflow-hidden shadow-xs hover:shadow-lg transition-shadow duration-300 flex flex-col justify-between"
							>
								<div className="p-6 sm:p-8 flex flex-col h-full justify-between">
									<div>
										<span className={`px-2.5 py-1 rounded text-[11px] font-extrabold tracking-wider uppercase ${project.color}`}>
											{project.sector}
										</span>
									...
									<div className="border-t border-gray-100 pt-6 mt-8">
										<div className="text-[28px] font-serif font-bold text-primary">{project.metric}</div>
					...
					<div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
						...
						<div className="bg-white rounded-xl overflow-hidden shadow-xs hover:shadow-xl border border-gray-150 transition-shadow duration-300">
							<div className="relative h-56 overflow-hidden">
								<img
									src="/extracted_images/image2.jpeg"
						...
						<div className="bg-white rounded-xl overflow-hidden shadow-xs hover:shadow-xl border border-gray-150 transition-shadow duration-300">
							<div className="relative h-56 overflow-hidden">
								<img
									src="/extracted_images/image16.jpeg"
						...
						<div className="bg-white rounded-xl overflow-hidden shadow-xs hover:shadow-xl border border-gray-150 transition-shadow duration-300">
							<div className="relative h-56 overflow-hidden">
								<img
									src="/extracted_images/image7.jpeg"
							...
							<div className="p-6">
								...
								<p className="text-muted text-[13px] leading-relaxed">
									"The computer and digital skill training program at Rudrapur gave me practical computer literacy and office software expertise. Today I work as a certified data entry executive."
								</p>
							</div>
						</div>
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					...
					<div className="grid grid-cols-1 md:grid-cols-2 gap-8">
						{galleryItems.map((item, idx) => (
							<div key={idx} className="relative overflow-hidden rounded-2xl group border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-300">
